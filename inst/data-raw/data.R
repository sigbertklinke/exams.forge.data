...
#save(distributions, file="../../data/distributions.rda", version=2, compress="bzip2")
skalenniveau  <- import("skalenniveau.xlsx", col_names=c("name", "type"))
#save(skalenniveau, file="../../data/skalenniveau.rda", version=2, compress="bzip2")
#### SOS data
...
save(sos100, file="../../data/sos100.rda", version=2, compress="bzip2")
sos200 <- sumofsquares(200, 10, maxt=Inf, zerosum=TRUE)
save(sos200, file="../../data/sos200.rda", version=2, compress="bzip2")
sos400 <- sumofsquares(400, 10, maxt=Inf, zerosum=TRUE)
save(sos400, file="../../data/sos400.rda", version=2, compress="bzip2")
sos800 <- sumofsquares(800, 10, maxt=Inf, zerosum=TRUE)
save(sos800, file="../../data/sos800.rda", version=2, compress="bzip2")
sos1000 <- sumofsquares(1000, 10, maxt=Inf, zerosum=TRUE)
save(sos1000, file="../../data/sos1000.rda", version=2, compress="bzip2")
